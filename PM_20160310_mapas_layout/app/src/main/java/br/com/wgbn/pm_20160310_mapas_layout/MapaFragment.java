...
public class MapaFragment extends Fragment {
    ...
    public void fetchData() {
        ...
        itemData.title = "A2 Engenharia Metalurgica";
        itemData.imageUrl = R.color.colorAccent;
        itemData.block = "Bloco";
        itemData.village = "Abrantes";
        try {
            itemData.latlong = "-12.8727741,-38.3033366";
        ...
        itemData2.title = "Clinica da Obesidade";
        itemData2.imageUrl = R.color.colorAccent;
        itemData2.block = "Bloco";
        itemData2.village = "Abrantes";
        try {
            itemData2.latlong = "-12.863809,-38.2755518";
            addToMap(itemData2.getLatlong().toString(), itemData2.getTitle());
        }
        catch (NullPointerException e){
    ...
    public class VagasAdapter extends RecyclerView.Adapter<VagasAdapter.ViewHolder> {
        ...
        public VagasAdapter(Context context ,  ArrayList<ItemData> itemsData) {
